...
describe('BraveAlerterConfigurator.js unit tests: getHistoricAlertsByAlertApiKey and createHistoricAlertFromRow', () => {
  beforeEach(() => {
    ...
    sandbox
      ...
      .withArgs('SUBSEQUENT_ALERT_MESSAGE_THRESHOLD')
      .returns(this.maxTimeAgoInMillis / 1000)
  ...
  it('db.getHistoricAlertsByAlertApiKey is called with the given alertApiKey, the given maxHistoricAlerts, and the SUBSEQUENT_ALERT_MESSAGE_THRESHOLD from .env', async () => {
    sandbox.stub(db, 'getHistoricAlertsByAlertApiKey').returns()
